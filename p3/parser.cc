...
#line 592 "parser.cc"
  ...
  case 4: // globals: globals term
#line 180 "holeyc.yy"
                  { (yylhs.value.transDeclList) = (yystack_[1].value.transDeclList); }
#line 598 "parser.cc"
    break;

  case 5: // callExp: id LPAREN RPAREN
#line 436 "holeyc.yy"
                  { 
...
#line 511 "holeyc.yy"
        ...
        (yystack_[0].value.transID)->myIsAt = true;
		    (yylhs.value.transExp) = (yystack_[0].value.transID); // $2 here is already an IDNode
		  }
#line 692 "parser.cc"
    break;

  case 16: // lval: CARAT id
#line 516 "holeyc.yy"
                  {
        (yystack_[0].value.transID)->myIsCarat = true;
		    (yylhs.value.transExp) = (yystack_[0].value.transID); // How to pass isCarat?
		  }
#line 701 "parser.cc"
    break;
...
#undef YYCASE_
  ...
  Parser::yypact_[] =
  {
     -33,     3,    -4,   -33,   -16,   -16,   -33,   -33,   -33,   -33,
     -33,   -33,   -33,   -33,   -33,   -33,   -25,   -33,   -33,   -32,
     -33
  };
  ...
  Parser::yydefact_[] =
  {
       3,     0,     2,     1,     0,     0,    11,    13,    17,     9,
       8,    10,    12,     7,     4,     6,    14,    15,    16,     0,
       5
  };
  ...
  Parser::yystos_[] =
  {
       0,    50,    51,     0,     4,     8,    10,    19,    21,    24,
      35,    44,    46,    52,    53,    54,    55,    55,    55,    32,
      40
  };
  ...
  "WHILE", "$accept", "program", "globals", "callExp", "term", "lval",
  "id", YY_NULLPTR
  };
#endif
  ...
  Parser::yyrline_[] =
  {
       0,   173,   173,   179,   180,   435,   460,   464,   469,   474,
     479,   484,   489,   493,   502,   510,   515,   521
  };
