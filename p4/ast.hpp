...
public:
	...
	virtual bool nameAnalysis(SymbolTable *, int) = 0;
private:
	size_t l;
	size_t c;
};
...
public:
	...
	virtual bool nameAnalysis(SymbolTable *, int) override;
private:
...
public:
	...
	bool nameAnalysis(SymbolTable *, int) override = 0;
};
...
public:
	...
	bool nameAnalysis(SymbolTable *, int) override;
...
public:
	...
	virtual bool nameAnalysis(SymbolTable *, int) override = 0;
};
...
public:
	...
	void unparse(std::ostream& out, int indent) override;
	bool nameAnalysis(SymbolTable *, int) override ;
  AssignExpNode * getMyExp() { return myExp; }
private:
	AssignExpNode * myExp;
};
...
public:
	...
	void unparse(std::ostream& out, int indent) override;
	bool nameAnalysis(SymbolTable *, int) override;
  ExpNode * getMyCond(){ return myCond; }
  std::list<StmtNode *> * getMyBody(){ return myBody; }
...
public:
	...
	void unparse(std::ostream& out, int indent) override;
	bool nameAnalysis(SymbolTable *, int) override;
  LValNode * getMyDst() { return myDst; }
	ExpNode * getMySrc() { return mySrc; }
private:
	LValNode * myDst;
	ExpNode * mySrc;
};
...
public:
	...
	void unparse(std::ostream& out, int indent) override;
	bool nameAnalysis(SymbolTable * symTab, int) override;
private:
	const int myNum;
};
...
public:
	...
	void unparse(std::ostream& out, int indent) override;
	bool nameAnalysis(SymbolTable *, int) override;
  CallExpNode * getMyCallExp() { return myCallExp; }
private:
